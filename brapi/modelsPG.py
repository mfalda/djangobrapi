...
class GermplasmAttributeValue(models.Model):
    ...
    determineddate = models.DateField(blank=True, null=True)
...
class Observation(models.Model):
    ...
    observationtimestamp = models.DateTimeField(blank=True, null=True)
...
class Study(models.Model):
    ...
    lastupdatetimestamp = models.DateTimeField(blank=True, null=True)
